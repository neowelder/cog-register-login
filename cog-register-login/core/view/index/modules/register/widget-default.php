    ...
    <form role="form" id='register'  method="post" action="add.php">
      ...
      <div class="row">
        ...
        <div class="col-xs-8 col-sm-9 col-md-9">
           Al dar click en el boton <strong class="label label-primary">Registrarme</strong>, aceptas los <a href="#" data-toggle="modal" data-target="#t_and_c_m">Terminos y condiciones</a>, Incluyendo el uso de Cookies.
